...
/**
 * Class "tx_CiMaintainance_Scheduler_FormhandlerChangesTask" provides a task that reports changes in formhandler-records
 *
 * @author		Cornelius Illi <cornelius.illi@student.hpi.uni-potsdam.de>
 * @package		TYPO3
 * @subpackage	tx_scheduler
 *
 * $Id: FormhandlerChanges.php $
 */
...
class tx_CiMaintainance_Scheduler_FormhandlerChangesTask 
